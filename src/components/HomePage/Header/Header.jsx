    ...
    return (
        ...
        <header className="crev-header">
                ...
                <div className="row">
                    <div className="col-lg-9">
                        <div className="caption">
                            <h1>High End <br /> <span className="stroke">Creative</span> Agency</h1>
                            <div className="row mt-30">
                                <div className="col-lg-5 offset-lg-1">
                                    <div className="text">
                                        <p>Through our years of experience, we've also learned that while each channel has its own set of advantages.</p>
                                    </div>
            ...
            <div className="main-img">
                <img src="https://ui-themez.smartinnovates.net/items/geekfolio/dark/assets/imgs/background/14.jpg" alt="" />
            </div>
            <div className="bg-pattern bg-img" data-background="assets/imgs/patterns/graph.png" />
        </header>
    );
