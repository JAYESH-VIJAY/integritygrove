                ...
                <div className="row">
                    <div className="col-lg-4">
                        <div className="serv-item lg-pad md-mb50 radius-5 wow fadeIn" data-wow-delay=".5s">
                            ...
                            <p className="fz-14">Creating a higher spacing and how people move through a unique.</p>
                            <div className="crv-more">
                                <a href="page-services.html" className="mt-30 ls1 fz-12 text-u">Read More<svg width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
